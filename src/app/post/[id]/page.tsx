      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <div className="bg-white rounded-xl border border-ink-100 p-6 mb-4">
          ...
          <div className="flex items-center gap-2 pt-4 border-t border-ink-50 flex-wrap">
            ...
            <button onClick={() => window.location.href='mailto:iletisim@otrsocial.com?subject=İçerik Şikayeti&body=Post ID: '+post.id} className='flex items-center gap-1.5 text-[12px] text-red-400 px-3 py-1.5 rounded-full border border-red-100 hover:bg-red-50 transition-colors'>Şikayet et</button>
          </div>
