  ...
  return (
    <>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        <h1 className="text-[28px] font-semibold text-[#0a0a0a] mb-2">Kullanım Koşulları</h1>
        ...
        <div className="space-y-8 text-[14px] text-ink-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">1. Kabul</h2>
            <p>Platformu kullanarak bu koşulları kabul etmiş sayılırsınız. Koşulları kabul etmiyorsanız platformu kullanmayınız.</p>
          </section>

          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">2. Platform Amacı</h2>
          ...
          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">3. Yasaklı İçerikler</h2>
          ...
          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">4. Anonim Paylaşım</h2>
          ...
          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">5. İçerik Moderasyonu</h2>
          ...
          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">6. Sorumluluk Sınırlaması</h2>
          ...
          <section>
            <h2 className="text-[16px] font-semibold text-[#0a0a0a] mb-3">7. Değişiklikler</h2>
