        ...
        <div className="bg-white rounded-xl border border-ink-100 p-6 mb-6">
          ...
          <div className="mt-4 pt-4 border-t border-ink-50 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <a href="/profil/duzenle" className="text-[12px] text-ink-600 hover:text-[#0a0a0a] px-3 py-1.5 rounded-lg border border-ink-200 hover:bg-ink-50 transition-colors">
                Düzenle
              </a>
